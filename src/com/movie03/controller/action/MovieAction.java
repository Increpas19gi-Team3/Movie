...
*/
		...
		System.out.println("Mcode : " + reqModel.get("Mcode"));
		Mcode = (String) reqModel.get("Mcode");*/
		...
		/*if (DetailMovie == null) {
			...
			// 영화코드로 영화상세정보를 가져옴
			list = mDAO.SelectOneMovieByCode(DetailMovie);
			// response - put
			respModel.put("DetailMovie", list);

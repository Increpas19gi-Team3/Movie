...
public class loginAction implements Action {
	...
	public String execute(Map<String, Object> reqModel, Map<String, Object> respModel) throws IOException {
		...
		if((String)reqModel.get("MID") != null){
			MID1 = (String)respModel.get("MID");			
		} else {
			System.out.println("ID: " + MID1);
		} 
		if((String)reqModel.get("Mpwd") != null){
			Mpwd1 = (String)respModel.get("Mpwd");			
		} else {
			System.out.println("ID: " + Mpwd1);
		} 
		if((String)reqModel.get("Madmin") != null){
			Madmin1 = (String)respModel.get("Madmin");			
		} else {
			System.out.println("ID: " + Madmin1);
		} 
		
		if(Login1 != null){// Login에서 받은 정보 값이 있다면
			// SQL문을 실행한후 받은 값들을 
			 login2 = Mdao.LoginConfirm(MID1, Mpwd1, Madmin1);
			respModel.put("login3", login2);			

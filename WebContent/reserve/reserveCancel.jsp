	...
	<div id="wrap" align="center">
		<form name="frm" method="post" action="/Movie/reserveCancel.do">
			<table>
				<tr>
					<th>예매번호 : </th>
					<td><input type="text" name="title" value="<%=request.getParameter("rcode")%>" readonly="readonly"></td>
				</tr>
				<tr>
					<th>영화제목 : </th>
				...
				<tr>
					<th>상영회차 : </th>
					<td><input type="text" name="title" value="<%=request.getParameter("turn")%>" readonly="readonly"></td>
				</tr>
				<tr>
					<th>좌석 : </th>
					<td><input type="text" name="title" value="<%=request.getParameter("seat")%>" readonly="readonly"></td>
				</tr>
			<tr></tr>

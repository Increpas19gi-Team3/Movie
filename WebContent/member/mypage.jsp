...
<%
	...
	// 이걸 왜 이렇게 만들었을까? ( list.get(0) )
	// ArrayList의 indexs number 0 를 가져와라? 이런 애기인가?
...
<div class="MemberDAO.java" align="center">
	...
	<form action="" method="post">
		<div class="log">
			<input type="hidden" name=MID value="" id="MID" placeholder="아이디"
				maxlength="20">
		</div>
		<div class="log">
			<input type="hidden" name=MNAME value="" id="MNAME" placeholder="이름"
				maxlength="20">
		</div>
		<div class="log">
			<input type="hidden" name=MEMAIL value="" id="MEMAIL"
				placeholder="이메일" maxlength="15">
		</div>
		<div class="log">
			<input type="hidden" name=MTEL value="" id="MTEL" placeholder="전화번호"
				maxlength="15">
		</div>
		<div class="log">
